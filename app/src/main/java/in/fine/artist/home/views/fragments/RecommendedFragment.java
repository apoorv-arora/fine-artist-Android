 ...
 */
public class RecommendedFragment extends BaseFragment implements RandomCallback, UploadManagerCallback {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        UploadManager.getInstance().addCallback(this
                    , UploadManager.COURSES_RECOMMENDED);
        ...
        mAdapter = new RecommendedAdapter(mActivity, loadList, this);
    ...
    private void refreshView() {
        UploadManager.getInstance().apiCall(new HashMap<String, String>(), UploadManager.COURSES_RECOMMENDED, null, null);
    }
