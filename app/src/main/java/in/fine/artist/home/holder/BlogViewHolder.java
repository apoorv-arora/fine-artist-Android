...
public class BlogViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setValues(ImageLoader loader, Activity mActivity, BlogUpdate course) {
        int width = mActivity.getWindowManager().getDefaultDisplay().getWidth();

        loader.setImageFromUrlOrDisk(course.getRefImageUrl(), backgroundImage, "", width, width, false);
